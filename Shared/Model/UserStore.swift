...
class UserStore: ObservableObject {
	...
	let recipes = [
		...
		Recipe(title: "Frog Sandwiches",
			   ingredients: [.init(name: "1 bread bun", icon: "🥯"),
							 .init(name: "1 slice of cheese", icon: "🧀"),
							 .init(name: "2 slices of ham", icon: "🍖"),
							 .init(name: "2 olives", icon: "🫒")],
			   steps: [.init(title: "Preparation",
							 body: "Wash your hands.\n\nPrepare a mixing bowl, a spoon and a tablespoon for measures.",
							imageName: "clean"),
					   .init(title: "Take Berries",
			   ...
			   category: .mainCourse,
			   trophies: [.cleaning, .cutting, .decorating],
			   requiredTrophyProgress: 0),
		...
		Recipe(title: "Egg Bunny",
			   ingredients: [.init(name: "2 eggs", icon: "🥚"),
							 .init(name: "1 carrot", icon: "🥕"),
							 .init(name: "Rosemary"),
							 .init(name: "Salt", icon: "🧂")],
			   steps: [.init(title: "Preparation",
							 body: "Wash your hands.\n\nPrepare a mixing bowl, a spoon and a tablespoon for measures.",
